class DropBoxController {
    constructor() {
        ...
        this.progressBarE1 = this.snackModalEl.querySelector('.mc-progress-bar-fg');
        this.nameFileE1 = this.snackModalEl.querySelector('.filename');
        this.timeLeftE1 = this.snackModalEl.querySelector('.timeleft');
        this.initEvents();
        this.firebaseConfig.initializeApp();
    }
    initializeApp() {
        
        const firebaseConfig = {
            apiKey: "AIzaSyCEpuO93VbUkfY2CNldEIKy9tLtSKfmHTg",
            authDomain: "dropbox-clone-4b361.firebaseapp.com",
            databaseURL: "https://dropbox-clone-4b361-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-4b361",
            storageBucket: "dropbox-clone-4b361.appspot.com",
            messagingSenderId: "1022886196553",
            appId: "1:1022886196553:web:d14fcb8df5ed2c5d611698",
            measurementId: "G-59VTS9VN7R"
        };
    ...
    getFirebaseRef() {
        return firebaseConfig.database().ref('files');
    }
    modalShow(show = true) {
